...
main(int argc, char *argv[])
{
  53:	bb 01 00 00 00       	mov    $0x1,%ebx
  58:	eb 09                	jmp    63 <main+0x63>
  ...
  66:	ff 76 08             	pushl  0x8(%esi)
  69:	e8 92 02 00 00       	call   300 <atoi>
  6e:	83 c4 10             	add    $0x10,%esp
  71:	39 c3                	cmp    %eax,%ebx
  73:	7c eb                	jl     60 <main+0x60>
		x += i;

	printprocinfo();
  75:	e8 26 00 00 00       	call   a0 <printprocinfo>

	exit();
  7a:	e8 f3 02 00 00       	call   372 <exit>
		exit();
	}
  ...
  7f:	50                   	push   %eax
  80:	50                   	push   %eax
  81:	68 02 08 00 00       	push   $0x802
  86:	6a 01                	push   $0x1
  88:	e8 43 04 00 00       	call   4d0 <printf>
  8d:	83 c4 10             	add    $0x10,%esp
  90:	eb c1                	jmp    53 <main+0x53>
  92:	66 90                	xchg   %ax,%ax
  94:	66 90                	xchg   %ax,%ax
  96:	66 90                	xchg   %ax,%ax
  98:	66 90                	xchg   %ax,%ax
...
void printprocinfo() 
{
  ...
  a4:	53                   	push   %ebx
	...
	if (getpinfo(&st) == -1) {
  a5:	8d 9d f8 fb ff ff    	lea    -0x408(%ebp),%ebx
  ab:	8d b5 f8 fc ff ff    	lea    -0x308(%ebp),%esi
#include "user.h"
#include "fs.h"
#include "pstat.h"
...
void printprocinfo() 
{
  b1:	81 ec 0c 04 00 00    	sub    $0x40c,%esp
	struct pstat st;
	int j;

	if (getpinfo(&st) == -1) {
  b7:	53                   	push   %ebx
  b8:	e8 5d 03 00 00       	call   41a <getpinfo>
  bd:	83 c4 10             	add    $0x10,%esp
  c0:	83 f8 ff             	cmp    $0xffffffff,%eax
  c3:	75 12                	jne    d7 <printprocinfo+0x37>
  c5:	eb 4d                	jmp    114 <printprocinfo+0x74>
  ...
  d5:	74 36                	je     10d <printprocinfo+0x6d>
	        if (st.inuse[j] == 1 && st.pid[j] >= 3) {
  d7:	83 3b 01             	cmpl   $0x1,(%ebx)
  da:	75 f4                	jne    d0 <printprocinfo+0x30>
  dc:	8b 83 00 02 00 00    	mov    0x200(%ebx),%eax
  e2:	83 f8 02             	cmp    $0x2,%eax
  e5:	7e e9                	jle    d0 <printprocinfo+0x30>
	            printf(1, "tickets: %d \t pid: %d \t ticks-used: %d\n", st.tickets[j], st.pid[j], st.ticks[j]);
  e7:	83 ec 0c             	sub    $0xc,%esp
  ea:	ff b3 00 03 00 00    	pushl  0x300(%ebx)
  f0:	83 c3 04             	add    $0x4,%ebx
  f3:	50                   	push   %eax
  f4:	ff b3 fc 00 00 00    	pushl  0xfc(%ebx)
  fa:	68 18 08 00 00       	push   $0x818
  ff:	6a 01                	push   $0x1
 ...
 10b:	75 ca                	jne    d7 <printprocinfo+0x37>
	        if (st.inuse[j] == 1 && st.pid[j] >= 3) {
	            printf(1, "tickets: %d \t pid: %d \t ticks-used: %d\n", st.tickets[j], st.pid[j], st.ticks[j]);
	        }
	    }
 ...
 113:	c3                   	ret    
{
 ...
 117:	68 f0 07 00 00       	push   $0x7f0
 11c:	6a 01                	push   $0x1
 11e:	e8 ad 03 00 00       	call   4d0 <printf>
 123:	83 c4 10             	add    $0x10,%esp
 126:	eb e5                	jmp    10d <printprocinfo+0x6d>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 46f:	f7 f6                	div    %esi
 471:	0f b6 92 68 08 00 00 	movzbl 0x868(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 5e8:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 5eb:	b8 60 08 00 00       	mov    $0x860,%eax
...
free(void *ap)
{
 ...
 671:	a1 34 0b 00 00       	mov    0xb34,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 6c7:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6c9:	a3 34 0b 00 00       	mov    %eax,0xb34
}
 6ce:	5b                   	pop    %ebx
 6cf:	5e                   	pop    %esi
 6d0:	5f                   	pop    %edi
 ...
 6ea:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 6ed:	a3 34 0b 00 00       	mov    %eax,0xb34
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 709:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 70c:	8b 15 34 0b 00 00    	mov    0xb34,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 7ac:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 7af:	89 15 34 0b 00 00    	mov    %edx,0xb34
      return (void*)(p + 1);
 ...
 7c4:	eb e9                	jmp    7af <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 7c6:	c7 05 34 0b 00 00 38 	movl   $0xb38,0xb34
 7cd:	0b 00 00 
 7d0:	c7 05 38 0b 00 00 38 	movl   $0xb38,0xb38
 7d7:	0b 00 00 
    base.s.size = 0;
 7da:	b8 38 0b 00 00       	mov    $0xb38,%eax
 7df:	c7 05 3c 0b 00 00 00 	movl   $0x0,0xb3c
 7e6:	00 00 00 
