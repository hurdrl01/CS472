...
main(int argc, char *argv[])
{
  ...
  *p = value;
  41:	89 1d 00 10 00 00    	mov    %ebx,0x1000

  if (munprotect((void *)p, 1) == -1) {
  47:	6a 01                	push   $0x1
  49:	68 00 10 00 00       	push   $0x1000
  4e:	e8 47 03 00 00       	call   39a <munprotect>
  53:	83 c4 10             	add    $0x10,%esp
  56:	83 f8 ff             	cmp    $0xffffffff,%eax
  59:	74 3f                	je     9a <main+0x9a>
  	printf(1, "munprotect call failed\n");
  } else {
  	printf(1, "munprotect call succeeded\n");
  5b:	83 ec 08             	sub    $0x8,%esp
  5e:	68 b7 07 00 00       	push   $0x7b7
  63:	6a 01                	push   $0x1
  ...
  70:	ff 35 00 10 00 00    	pushl  0x1000
  76:	68 d2 07 00 00       	push   $0x7d2
  7b:	6a 01                	push   $0x1
  7d:	e8 ce 03 00 00       	call   450 <printf>
  ...
  *p = value;
  ...
  87:	52                   	push   %edx
  88:	52                   	push   %edx
  89:	68 70 07 00 00       	push   $0x770
  8e:	6a 01                	push   $0x1
  90:	e8 bb 03 00 00       	call   450 <printf>
  95:	83 c4 10             	add    $0x10,%esp
  98:	eb a4                	jmp    3e <main+0x3e>
  }
  ...
  *p = value;
  ...
  9a:	50                   	push   %eax
  9b:	50                   	push   %eax
  9c:	68 9f 07 00 00       	push   $0x79f
  a1:	6a 01                	push   $0x1
  a3:	e8 a8 03 00 00       	call   450 <printf>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3ef:	f7 f6                	div    %esi
 3f1:	0f b6 92 e0 07 00 00 	movzbl 0x7e0(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 568:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 56b:	b8 d6 07 00 00       	mov    $0x7d6,%eax
