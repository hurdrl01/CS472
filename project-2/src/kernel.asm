...
80101e98:	68 62 76 10 80       	push   $0x80107662
...
80102e12:	e8 e9 28 00 00       	call   80105700 <idtinit>
...
80102e33:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102e36:	e8 e5 39 00 00       	call   80106820 <switchkvm>
  seginit();
...
80102e99:	e8 52 2b 00 00       	call   801059f0 <uartinit>
  pinit();         // process table
80102e9e:	e8 0d 08 00 00       	call   801036b0 <pinit>
  tvinit();        // trap vectors
80102ea3:	e8 b8 27 00 00       	call   80105660 <tvinit>
  binit();         // buffer cache
...
801035da:	c7 43 0c 01 00 00 00 	movl   $0x1,0xc(%ebx)
  ...
  release(&ptable.lock);
801035e1:	68 40 2d 11 80       	push   $0x80112d40
  release(&ptable.lock);
  return 0;
...
80103614:	89 53 18             	mov    %edx,0x18(%ebx)
  ...
  sp -= 4;
  *(uint*)sp = (uint)trapret;
80103617:	c7 40 14 52 56 10 80 	movl   $0x80105652,0x14(%eax)
...
80103643:	68 40 2d 11 80       	push   $0x80112d40
...
801036dc:	e8 ff ef ff ff       	call   801026e0 <lapicid>
  ...
  for (i = 0; i < ncpu; ++i) {
801036e1:	8b 35 20 2d 11 80    	mov    0x80112d20,%esi
801036e7:	85 f6                	test   %esi,%esi
801036e9:	7e 3f                	jle    8010372a <mycpu+0x5a>
    if (cpus[i].apicid == apicid)
801036eb:	0f b6 15 a0 27 11 80 	movzbl 0x801127a0,%edx
801036f2:	39 d0                	cmp    %edx,%eax
801036f4:	74 30                	je     80103726 <mycpu+0x56>
801036f6:	b9 50 28 11 80       	mov    $0x80112850,%ecx
...
8010371d:	5b                   	pop    %ebx
  ...
  for (i = 0; i < ncpu; ++i) {
    if (cpus[i].apicid == apicid)
      return &cpus[i];
8010371e:	05 a0 27 11 80       	add    $0x801127a0,%eax
  }
  panic("unknown apicid\n");
}
80103723:	5e                   	pop    %esi
...
8010375b:	2d a0 27 11 80       	sub    $0x801127a0,%eax
}
80103760:	c9                   	leave  
}
...
801037b3:	e8 88 34 00 00       	call   80106c40 <setupkvm>
...
801037d1:	e8 7a 31 00 00       	call   80106950 <inituvm>
  p->sz = PGSIZE;
...
80103856:	89 43 68             	mov    %eax,0x68(%ebx)
  ...
  acquire(&ptable.lock);
80103859:	c7 04 24 40 2d 11 80 	movl   $0x80112d40,(%esp)
...
80103865:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  ...
  release(&ptable.lock);
8010386c:	c7 04 24 40 2d 11 80 	movl   $0x80112d40,(%esp)
...
801038be:	e8 cd 31 00 00       	call   80106a90 <allocuvm>
...
801038d0:	e8 6b 2f 00 00       	call   80106840 <switchuvm>
  return 0;
...
801038f4:	e8 97 32 00 00       	call   80106b90 <deallocuvm>
...
80103948:	e8 c3 33 00 00       	call   80106d10 <copyuvm>
...
80103a51:	83 ec 0c             	sub    $0xc,%esp
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103a54:	bb 74 2d 11 80       	mov    $0x80112d74,%ebx
  for(;;){
    // Enable interrupts on this processor.
    sti();
    ...
    // Loop over process table looking for process to run.
    acquire(&ptable.lock);
80103a59:	68 40 2d 11 80       	push   $0x80112d40
...
80103a73:	81 fb 74 4c 11 80    	cmp    $0x80114c74,%ebx
...
80103a8b:	83 c3 7c             	add    $0x7c,%ebx
      ...
      c->proc = p;
      switchuvm(p);
80103a8e:	e8 ad 2d 00 00       	call   80106840 <switchuvm>
      p->state = RUNNING;
...
80103aa0:	e8 c6 0b 00 00       	call   8010466b <swtch>
      switchkvm();
80103aa5:	e8 76 2d 00 00       	call   80106820 <switchkvm>
...
80103aaa:	83 c4 10             	add    $0x10,%esp
    ...
    acquire(&ptable.lock);
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103aad:	81 fb 74 4c 11 80    	cmp    $0x80114c74,%ebx
      swtch(&(c->scheduler), p->context);
      switchkvm();
...
80103ac3:	68 40 2d 11 80       	push   $0x80112d40
...
80103afd:	68 40 2d 11 80       	push   $0x80112d40
...
80103c04:	c7 46 68 00 00 00 00 	movl   $0x0,0x68(%esi)
  ...
  acquire(&ptable.lock);
80103c0b:	c7 04 24 40 2d 11 80 	movl   $0x80112d40,(%esp)
...
80103c47:	3d 74 4c 11 80       	cmp    $0x80114c74,%eax
...
80103c54:	ba 74 2d 11 80       	mov    $0x80112d74,%edx
...
80103c63:	81 fa 74 4c 11 80    	cmp    $0x80114c74,%edx
...
80103c79:	b8 74 2d 11 80       	mov    $0x80112d74,%eax
...
80103c83:	3d 74 4c 11 80       	cmp    $0x80114c74,%eax
...
80103cd7:	68 40 2d 11 80       	push   $0x80112d40
...
80103cfd:	e8 de fd ff ff       	call   80103ae0 <sched>
  release(&ptable.lock);
80103d02:	c7 04 24 40 2d 11 80 	movl   $0x80112d40,(%esp)
...
80103d50:	81 fe 40 2d 11 80    	cmp    $0x80112d40,%esi
80103d56:	74 50                	je     80103da8 <sleep+0x88>
    acquire(&ptable.lock);  //DOC: sleeplock1
80103d58:	83 ec 0c             	sub    $0xc,%esp
80103d5b:	68 40 2d 11 80       	push   $0x80112d40
...
80103d7c:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
  ...
  if(lk != &ptable.lock){  //DOC: sleeplock2
    release(&ptable.lock);
80103d83:	c7 04 24 40 2d 11 80 	movl   $0x80112d40,(%esp)
...
80103e31:	b8 01 00 00 00       	mov    $0x1,%eax
  ...
  for(;;){
    ...
    havekids = 0;
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103e36:	81 fb 74 4c 11 80    	cmp    $0x80114c74,%ebx
...
80103e4e:	68 40 2d 11 80       	push   $0x80112d40
...
80103e70:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80103e77:	e8 44 2d 00 00       	call   80106bc0 <freevm>
        p->pid = 0;
...
80103e95:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
80103e9c:	c7 04 24 40 2d 11 80 	movl   $0x80112d40,(%esp)
...
80103eb7:	68 40 2d 11 80       	push   $0x80112d40
...
80103ed7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&ptable.lock);
80103eda:	68 40 2d 11 80       	push   $0x80112d40
...
80103f0f:	3d 74 4c 11 80       	cmp    $0x80114c74,%eax
...
wakeup(void *chan)
{
  ...
  wakeup1(chan);
  release(&ptable.lock);
80103f16:	c7 45 08 40 2d 11 80 	movl   $0x80112d40,0x8(%ebp)
}
...
80103fc9:	bb e0 2d 11 80       	mov    $0x80112de0,%ebx
...
80103fdb:	68 7b 78 10 80       	push   $0x8010787b
...
80103fe8:	83 c3 7c             	add    $0x7c,%ebx
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103feb:	81 fb e0 4c 11 80    	cmp    $0x80114ce0,%ebx
...
80104680:	55                   	push   %ebp
	return readCount;
80104681:	a1 bc a5 10 80       	mov    0x8010a5bc,%eax
}
...
80104697:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
8010469a:	e8 d1 f0 ff ff       	call   80103770 <myproc>
...
80104735:	e8 36 f0 ff ff       	call   80103770 <myproc>
...
80104788:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
8010478b:	e8 e0 ef ff ff       	call   80103770 <myproc>
...
80104824:	53                   	push   %ebx
  int num;
  struct proc *curproc = myproc();
80104825:	e8 46 ef ff ff       	call   80103770 <myproc>
...
8010482d:	89 c3                	mov    %eax,%ebx
  ...
  num = curproc->tf->eax;
8010482f:	8b 56 1c             	mov    0x1c(%esi),%edx
  
   if(num == 5) {
80104832:	83 fa 05             	cmp    $0x5,%edx
80104835:	74 59                	je     80104890 <syscall+0x70>
  	readCount++;
  }

  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
80104837:	8d 42 ff             	lea    -0x1(%edx),%eax
8010483a:	83 f8 15             	cmp    $0x15,%eax
8010483d:	77 21                	ja     80104860 <syscall+0x40>
8010483f:	8b 04 95 e0 75 10 80 	mov    -0x7fef8a20(,%edx,4),%eax
80104846:	85 c0                	test   %eax,%eax
80104848:	74 16                	je     80104860 <syscall+0x40>
    curproc->tf->eax = syscalls[num]();
8010484a:	ff d0                	call   *%eax
8010484c:	89 46 1c             	mov    %eax,0x1c(%esi)
  } else {
...
80104859:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
  ...
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
    ...
    cprintf("%d %s: unknown sys call %d\n",
            curproc->pid, curproc->name, num);
80104860:	8d 43 6c             	lea    0x6c(%ebx),%eax
  }
...
80104868:	68 b1 75 10 80       	push   $0x801075b1
...
80104889:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
  ...
  num = curproc->tf->eax;
   ...
   if(num == 5) {
  	readCount++;
80104890:	83 05 bc a5 10 80 01 	addl   $0x1,0x8010a5bc
80104897:	eb 9e                	jmp    80104837 <syscall+0x17>
...
80104a52:	e8 d9 fc ff ff       	call   80104730 <argint>
...
80104a64:	e8 07 ed ff ff       	call   80103770 <myproc>
...
fdalloc(struct file *f)
{
  int fd;
  struct proc *curproc = myproc();
80104acb:	e8 a0 ec ff ff       	call   80103770 <myproc>
...
80104b2d:	e8 fe fb ff ff       	call   80104730 <argint>
...
80104b45:	e8 36 fc ff ff       	call   80104780 <argptr>
...
80104b9d:	e8 8e fb ff ff       	call   80104730 <argint>
...
80104bb5:	e8 c6 fb ff ff       	call   80104780 <argptr>
...
80104c03:	78 2b                	js     80104c30 <sys_close+0x40>
    return -1;
  myproc()->ofile[fd] = 0;
80104c05:	e8 66 eb ff ff       	call   80103770 <myproc>
...
80104c5f:	e8 1c fb ff ff       	call   80104780 <argptr>
...
80104c9f:	e8 3c fb ff ff       	call   801047e0 <argstr>
...
80104cb8:	e8 23 fb ff ff       	call   801047e0 <argstr>
...
80104dff:	e8 dc f9 ff ff       	call   801047e0 <argstr>
...
80104eb2:	e8 59 f5 ff ff       	call   80104410 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
...
80104fef:	e8 ec f7 ff ff       	call   801047e0 <argstr>
...
80105008:	e8 23 f7 ff ff       	call   80104730 <argint>
...
fdalloc(struct file *f)
{
  int fd;
  struct proc *curproc = myproc();
80105063:	e8 08 e7 ff ff       	call   80103770 <myproc>
80105068:	90                   	nop
...
80105154:	e8 87 f6 ff ff       	call   801047e0 <argstr>
...
801051b4:	e8 27 f6 ff ff       	call   801047e0 <argstr>
...
801051c9:	e8 62 f5 ff ff       	call   80104730 <argint>
  struct inode *ip;
  char *path;
  int major, minor;
...
801051de:	e8 4d f5 ff ff       	call   80104730 <argint>
  char *path;
  int major, minor;
...
80105235:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
80105238:	e8 33 e5 ff ff       	call   80103770 <myproc>
...
8010524d:	e8 8e f5 ff ff       	call   801047e0 <argstr>
...
801052f5:	e8 e6 f4 ff ff       	call   801047e0 <argstr>
...
8010530d:	e8 1e f4 ff ff       	call   80104730 <argint>
...
80105338:	e8 d3 f0 ff ff       	call   80104410 <memset>
...
8010534e:	e8 3d f3 ff ff       	call   80104690 <fetchint>
...
80105369:	e8 62 f3 ff ff       	call   801046d0 <fetchstr>
...
801053d1:	e8 aa f3 ff ff       	call   80104780 <argptr>
...
fdalloc(struct file *f)
{
  int fd;
  struct proc *curproc = myproc();
801053f9:	e8 72 e3 ff ff       	call   80103770 <myproc>
...
fdalloc(struct file *f)
{
  int fd;
  struct proc *curproc = myproc();
80105442:	e8 29 e3 ff ff       	call   80103770 <myproc>
...
8010545e:	75 f0                	jne    80105450 <sys_pipe+0x90>
  ...
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
    if(fd0 >= 0)
      myproc()->ofile[fd0] = 0;
80105460:	e8 0b e3 ff ff       	call   80103770 <myproc>
...
{
  return fork();
80105494:	e9 77 e4 ff ff       	jmp    80103910 <fork>
...
801054a3:	83 ec 08             	sub    $0x8,%esp
  exit();
801054a6:	e8 f5 e6 ff ff       	call   80103ba0 <exit>
...
{
  return wait();
801054b4:	e9 27 e9 ff ff       	jmp    80103de0 <wait>
...
801054cc:	e8 5f f2 ff ff       	call   80104730 <argint>
...
801054de:	e8 4d ea ff ff       	call   80103f30 <kill>
...
80105503:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80105506:	e8 65 e2 ff ff       	call   80103770 <myproc>
...
80105536:	e8 55 e3 ff ff       	call   80103890 <growproc>
...
80105580:	68 80 4c 11 80       	push   $0x80114c80
80105585:	e8 86 ed ff ff       	call   80104310 <acquire>
  ticks0 = ticks;
...
8010558d:	83 c4 10             	add    $0x10,%esp
  ...
  acquire(&tickslock);
  ticks0 = ticks;
80105590:	8b 1d c0 54 11 80    	mov    0x801154c0,%ebx
  while(ticks - ticks0 < n){
...
801055a3:	68 80 4c 11 80       	push   $0x80114c80
801055a8:	68 c0 54 11 80       	push   $0x801154c0
801055ad:	e8 6e e7 ff ff       	call   80103d20 <sleep>
  ...
  ticks0 = ticks;
  while(ticks - ticks0 < n){
801055b2:	a1 c0 54 11 80       	mov    0x801154c0,%eax
...
801055bf:	73 2f                	jae    801055f0 <sys_sleep+0x90>
    if(myproc()->killed){
801055c1:	e8 aa e1 ff ff       	call   80103770 <myproc>
...
801055d5:	e8 e6 ed ff ff       	call   801043c0 <release>
      return -1;
...
801055f8:	e8 c3 ed ff ff       	call   801043c0 <release>
  return 0;
...
80105614:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105617:	68 80 4c 11 80       	push   $0x80114c80
8010561c:	e8 ef ec ff ff       	call   80104310 <acquire>
  xticks = ticks;
80105621:	8b 1d c0 54 11 80    	mov    0x801154c0,%ebx
  release(&tickslock);
80105627:	c7 04 24 80 4c 11 80 	movl   $0x80114c80,(%esp)
8010562e:	e8 8d ed ff ff       	call   801043c0 <release>
  return xticks;
}
...
80105674:	c6 04 c5 c4 4c 11 80 	movb   $0x0,-0x7feeb33c(,%eax,8)
8010567b:	00 
8010567c:	66 89 0c c5 c2 4c 11 	mov    %cx,-0x7feeb33e(,%eax,8)
80105683:	80 
80105684:	c6 04 c5 c5 4c 11 80 	movb   $0x8e,-0x7feeb33b(,%eax,8)
8010568b:	8e 
8010568c:	66 89 14 c5 c0 4c 11 	mov    %dx,-0x7feeb340(,%eax,8)
80105693:	80 
80105694:	c1 ea 10             	shr    $0x10,%edx
80105697:	66 89 14 c5 c6 4c 11 	mov    %dx,-0x7feeb33a(,%eax,8)
8010569e:	80 
void
tvinit(void)
{
...
801056be:	68 80 4c 11 80       	push   $0x80114c80
{
  int i;
  ...
  for(i = 0; i < 256; i++)
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
801056c3:	66 89 15 c2 4e 11 80 	mov    %dx,0x80114ec2
801056ca:	c6 05 c4 4e 11 80 00 	movb   $0x0,0x80114ec4
801056d1:	66 a3 c0 4e 11 80    	mov    %ax,0x80114ec0
801056d7:	c1 e8 10             	shr    $0x10,%eax
801056da:	c6 05 c5 4e 11 80 ef 	movb   $0xef,0x80114ec5
801056e1:	66 a3 c6 4e 11 80    	mov    %ax,0x80114ec6

  initlock(&tickslock, "time");
801056e7:	e8 c4 ea ff ff       	call   801041b0 <initlock>
}
...
801057e5:	e8 86 df ff ff       	call   80103770 <myproc>
801057ea:	85 c0                	test   %eax,%eax
801057ec:	74 0b                	je     801057f9 <trap+0xc9>
801057ee:	e8 7d df ff ff       	call   80103770 <myproc>
...
8010584c:	75 ab                	jne    801057f9 <trap+0xc9>
     tf->trapno == T_IRQ0+IRQ_TIMER)
    yield();
8010584e:	e8 7d e4 ff ff       	call   80103cd0 <yield>
...
80105855:	8d 76 00             	lea    0x0(%esi),%esi
  ...
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
80105858:	e8 f3 de ff ff       	call   80103750 <cpuid>
...
8010586f:	90                   	nop
  ...
  case T_IRQ0 + IRQ_KBD:
    kbdintr();
80105870:	e8 4b cd ff ff       	call   801025c0 <kbdintr>
    lapiceoi();
...
80105897:	e8 b4 de ff ff       	call   80103750 <cpuid>
...
801058a4:	e8 b7 ad ff ff       	call   80100660 <cprintf>
            cpuid(), tf->cs, tf->eip);
    lapiceoi();
801058a9:	e8 52 ce ff ff       	call   80102700 <lapiceoi>
    break;
...
801058b9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
  ...
  case T_IRQ0 + IRQ_IDE:
    ideintr();
801058c0:	e8 7b c7 ff ff       	call   80102040 <ideintr>
...
801058da:	75 2c                	jne    80105908 <trap+0x1d8>
      exit();
    myproc()->tf = tf;
801058dc:	e8 8f de ff ff       	call   80103770 <myproc>
801058e1:	89 78 18             	mov    %edi,0x18(%eax)
    syscall();
801058e4:	e8 37 ef ff ff       	call   80104820 <syscall>
    if(myproc()->killed)
...
801058ff:	5d                   	pop    %ebp
    ...
    if(myproc()->killed)
      exit();
80105900:	e9 9b e2 ff ff       	jmp    80103ba0 <exit>
...
trap(struct trapframe *tf)
{
  if(tf->trapno == T_SYSCALL){
    if(myproc()->killed)
      exit();
80105908:	e8 93 e2 ff ff       	call   80103ba0 <exit>
...
80105913:	68 80 4c 11 80       	push   $0x80114c80
80105918:	e8 f3 e9 ff ff       	call   80104310 <acquire>
      ticks++;
      wakeup(&ticks);
8010591d:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
  ...
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
      acquire(&tickslock);
      ticks++;
80105924:	83 05 c0 54 11 80 01 	addl   $0x1,0x801154c0
      wakeup(&ticks);
8010592b:	e8 a0 e5 ff ff       	call   80103ed0 <wakeup>
      release(&tickslock);
80105930:	c7 04 24 80 4c 11 80 	movl   $0x80114c80,(%esp)
...
8010594a:	e8 01 de ff ff       	call   80103750 <cpuid>
...
801059c5:	e8 56 cd ff ff       	call   80102720 <microdelay>
{
  int i;
...
80105a68:	e8 23 c8 ff ff       	call   80102290 <ioapicenable>
...
801065b4:	e8 c7 be ff ff       	call   80102480 <kalloc>
...
801066c4:	e8 07 bc ff ff       	call   801022d0 <kfree>
      *pte = 0;
...
80106712:	68 66 71 10 80       	push   $0x80107166
...
80106723:	83 ec 18             	sub    $0x18,%esp
  ...
  c = &cpus[cpuid()];
80106726:	e8 25 d0 ff ff       	call   80103750 <cpuid>
...
80106738:	66 89 90 18 28 11 80 	mov    %dx,-0x7feed7e8(%eax)
8010673f:	66 89 88 1a 28 11 80 	mov    %cx,-0x7feed7e6(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106746:	ba ff ff ff ff       	mov    $0xffffffff,%edx
8010674b:	31 c9                	xor    %ecx,%ecx
8010674d:	66 89 90 20 28 11 80 	mov    %dx,-0x7feed7e0(%eax)
...
80106754:	ba ff ff ff ff       	mov    $0xffffffff,%edx
  ...
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106759:	66 89 88 22 28 11 80 	mov    %cx,-0x7feed7de(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106760:	31 c9                	xor    %ecx,%ecx
80106762:	66 89 90 28 28 11 80 	mov    %dx,-0x7feed7d8(%eax)
80106769:	66 89 88 2a 28 11 80 	mov    %cx,-0x7feed7d6(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106770:	ba ff ff ff ff       	mov    $0xffffffff,%edx
80106775:	31 c9                	xor    %ecx,%ecx
80106777:	66 89 90 30 28 11 80 	mov    %dx,-0x7feed7d0(%eax)
  // Map "logical" addresses to virtual addresses using identity map.
  // Cannot share a CODE descriptor for both kernel and user
  // because it would have to have DPL_USR, but the CPU forbids
  // an interrupt from CPL=0 to DPL=3.
  c = &cpus[cpuid()];
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
8010677e:	c6 80 1c 28 11 80 00 	movb   $0x0,-0x7feed7e4(%eax)
static inline void
...
8010678a:	c6 80 1d 28 11 80 9a 	movb   $0x9a,-0x7feed7e3(%eax)
80106791:	c6 80 1e 28 11 80 cf 	movb   $0xcf,-0x7feed7e2(%eax)
80106798:	c6 80 1f 28 11 80 00 	movb   $0x0,-0x7feed7e1(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
8010679f:	c6 80 24 28 11 80 00 	movb   $0x0,-0x7feed7dc(%eax)
801067a6:	c6 80 25 28 11 80 92 	movb   $0x92,-0x7feed7db(%eax)
801067ad:	c6 80 26 28 11 80 cf 	movb   $0xcf,-0x7feed7da(%eax)
801067b4:	c6 80 27 28 11 80 00 	movb   $0x0,-0x7feed7d9(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
801067bb:	c6 80 2c 28 11 80 00 	movb   $0x0,-0x7feed7d4(%eax)
801067c2:	c6 80 2d 28 11 80 fa 	movb   $0xfa,-0x7feed7d3(%eax)
801067c9:	c6 80 2e 28 11 80 cf 	movb   $0xcf,-0x7feed7d2(%eax)
801067d0:	c6 80 2f 28 11 80 00 	movb   $0x0,-0x7feed7d1(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
801067d7:	66 89 88 32 28 11 80 	mov    %cx,-0x7feed7ce(%eax)
801067de:	c6 80 34 28 11 80 00 	movb   $0x0,-0x7feed7cc(%eax)
801067e5:	c6 80 35 28 11 80 f2 	movb   $0xf2,-0x7feed7cb(%eax)
801067ec:	c6 80 36 28 11 80 cf 	movb   $0xcf,-0x7feed7ca(%eax)
801067f3:	c6 80 37 28 11 80 00 	movb   $0x0,-0x7feed7c9(%eax)
...
80106864:	0f 84 c4 00 00 00    	je     8010692e <switchuvm+0xee>
  ...
  pushcli();
8010686a:	e8 c1 d9 ff ff       	call   80104230 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
8010686f:	e8 5c ce ff ff       	call   801036d0 <mycpu>
80106874:	89 c3                	mov    %eax,%ebx
80106876:	e8 55 ce ff ff       	call   801036d0 <mycpu>
8010687b:	89 c7                	mov    %eax,%edi
8010687d:	e8 4e ce ff ff       	call   801036d0 <mycpu>
...
801068c9:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
  ...
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
                                sizeof(mycpu()->ts)-1, 0);
  mycpu()->gdt[SEG_TSS].s = 0;
801068ce:	e8 fd cd ff ff       	call   801036d0 <mycpu>
801068d3:	80 a0 9d 00 00 00 ef 	andb   $0xef,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
801068da:	e8 f1 cd ff ff       	call   801036d0 <mycpu>
...
801068f6:	89 48 0c             	mov    %ecx,0xc(%eax)
  ...
  // forbids I/O instructions (e.g., inb and outb) from user space
  mycpu()->ts.iomb = (ushort) 0xFFFF;
801068f9:	e8 d2 cd ff ff       	call   801036d0 <mycpu>
...
8010691b:	5d                   	pop    %ebp
  ...
  lcr3(V2P(p->pgdir));  // switch to process's address space
  popcli();
8010691c:	e9 4f d9 ff ff       	jmp    80104270 <popcli>
// Switch TSS and h/w page table to correspond to process p.
void
switchuvm(struct proc *p)
{
...
8010696b:	77 49                	ja     801069b6 <inituvm+0x66>
  ...
  mem = kalloc();
8010696d:	e8 0e bb ff ff       	call   80102480 <kalloc>
  memset(mem, 0, PGSIZE);
...
80106a41:	e8 fa ae ff ff       	call   80101940 <readi>
...
80106b01:	76 7d                	jbe    80106b80 <allocuvm+0xf0>
    mem = kalloc();
80106b03:	e8 78 b9 ff ff       	call   80102480 <kalloc>
    if(mem == 0){
...
80106b66:	e8 65 b7 ff ff       	call   801022d0 <kfree>
      return 0;
...
80106c0e:	e8 bd b6 ff ff       	call   801022d0 <kfree>
...
80106c23:	5d                   	pop    %ebp
  ...
  kfree((char*)pgdir);
80106c24:	e9 a7 b6 ff ff       	jmp    801022d0 <kfree>
freevm(pde_t *pgdir)
{
  uint i;
...
80106d23:	0f 84 c5 00 00 00    	je     80106dee <copyuvm+0xde>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
...
80106d75:	78 69                	js     80106de0 <copyuvm+0xd0>
  uint pa, i, flags;
  char *mem;
...
80106d90:	74 6d                	je     80106dff <copyuvm+0xef>
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
80106d92:	8b 00                	mov    (%eax),%eax
80106d94:	a8 01                	test   $0x1,%al
80106d96:	74 5a                	je     80106df2 <copyuvm+0xe2>
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
...
80106da5:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if((mem = kalloc()) == 0)
80106da8:	e8 d3 b6 ff ff       	call   80102480 <kalloc>
...
80106de4:	e8 e7 b4 ff ff       	call   801022d0 <kfree>
      goto bad;
80106de9:	83 c4 10             	add    $0x10,%esp
80106dec:	eb c5                	jmp    80106db3 <copyuvm+0xa3>
  pte_t *pte;
  uint pa, i, flags;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
    return 0;
80106dee:	31 c0                	xor    %eax,%eax
80106df0:	eb d1                	jmp    80106dc3 <copyuvm+0xb3>
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
...
80106df5:	68 b2 78 10 80       	push   $0x801078b2
80106dfa:	e8 71 95 ff ff       	call   80100370 <panic>
...
80106e02:	68 98 78 10 80       	push   $0x80107898
...
80106e1e:	e8 4d f7 ff ff       	call   80106570 <walkpgdir>
  if((*pte & PTE_P) == 0)
