...
main(int argc, char *argv[]) {
  19:	81 ec 88 00 00 00    	sub    $0x88,%esp
    int x1 = getreadcount();
  1f:	e8 3e 03 00 00       	call   362 <getreadcount>
  24:	89 85 74 ff ff ff    	mov    %eax,-0x8c(%ebp)

    int rc = fork();
  2a:	e8 8b 02 00 00       	call   2ba <fork>
  ...
  3d:	56                   	push   %esi
  3e:	6a 04                	push   $0x4
  40:	e8 95 02 00 00       	call   2da <read>
  ...
  4f:	7e 21                	jle    72 <main+0x72>
	(void) wait();
  51:	e8 74 02 00 00       	call   2ca <wait>
	int x2 = getreadcount();
  56:	e8 07 03 00 00       	call   362 <getreadcount>
	total += (x2 - x1);
	printf(1, "XV6_TEST_OUTPUT %d\n", total);
  5b:	2b 85 74 ff ff ff    	sub    -0x8c(%ebp),%eax
  61:	52                   	push   %edx
  62:	50                   	push   %eax
  63:	68 30 07 00 00       	push   $0x730
  68:	6a 01                	push   $0x1
