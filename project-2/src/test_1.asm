...
main(int argc, char *argv[]) {
  ...
  int x1 = getreadcount();
  1f:	e8 5e 03 00 00       	call   382 <getreadcount>
  24:	89 85 74 ff ff ff    	mov    %eax,-0x8c(%ebp)
  int x2 = getreadcount();
  2a:	e8 53 03 00 00       	call   382 <getreadcount>
  char buf[100];
  (void) read(4, buf, 1);
...
main(int argc, char *argv[]) {
  ...
  3a:	56                   	push   %esi
  3b:	6a 04                	push   $0x4
  3d:	e8 b8 02 00 00       	call   2fa <read>
  int x3 = getreadcount();
  42:	e8 3b 03 00 00       	call   382 <getreadcount>
  ...
  55:	56                   	push   %esi
  56:	6a 04                	push   $0x4
  58:	e8 9d 02 00 00       	call   2fa <read>
  int x2 = getreadcount();
  char buf[100];
  (void) read(4, buf, 1);
  int x3 = getreadcount();
  ...
  int x4 = getreadcount();
  65:	e8 18 03 00 00       	call   382 <getreadcount>
  ...
  7e:	57                   	push   %edi
  7f:	50                   	push   %eax
  80:	68 50 07 00 00       	push   $0x750
  85:	6a 01                	push   $0x1
  87:	e8 a4 03 00 00       	call   430 <printf>
  exit();
  8c:	83 c4 20             	add    $0x20,%esp
  8f:	e8 4e 02 00 00       	call   2e2 <exit>
  94:	66 90                	xchg   %ax,%ax
  96:	66 90                	xchg   %ax,%ax
  98:	66 90                	xchg   %ax,%ax
  9a:	66 90                	xchg   %ax,%ax
...
putc(int fd, char c)
{
 ...
 548:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 54b:	b8 6a 07 00 00       	mov    $0x76a,%eax
